...
public abstract class Hilt_ServiceActionReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((ServiceActionReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectServiceActionReceiver(UnsafeCasts.<ServiceActionReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
